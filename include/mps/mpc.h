...
void mpc_add_ui(mpc_t rc, mpc_t c, unsigned long int r, unsigned long int i);
void mpc_sub(mpc_t rc, mpc_t c1, mpc_t c2);
void mpc_sub_f(mpc_t rc, mpc_t c, mpf_t f);
void mpc_f_sub(mpc_t rc, mpf_t f, mpc_t c);
void mpc_sub_ui(mpc_t rc, mpc_t c, unsigned long int r, unsigned long int i);
void mpc_ui_sub(mpc_t rc, unsigned long int r, unsigned long int i, mpc_t c);
