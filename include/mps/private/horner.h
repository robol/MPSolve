...
void mps_parhorner (mps_context * st, int n, mpcf_t x, mpcf_t p[],
                    mps_boolean b[], mpcf_t s, int n_thread);
...
void mps_mhorner (mps_context * s, mps_monomial_poly * p, mpcf_t x, mpcf_t value);
void mps_mhorner_with_error (mps_context * s, mps_monomial_poly * p,
                             mpcf_t x, mpcf_t value, rdpe_t relative_error, long int wp);
void mps_mhorner_with_error2 (mps_context * s, mps_monomial_poly * p, mpcf_t x,
                              mpcf_t value, rdpe_t relative_error, long int wp);
