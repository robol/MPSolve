...
void mps_mnewton_usr (mps_context * st, mps_polynomial * poly, mps_approximation * root, mpcf_t corr, long int wp);
...
mps_boolean mps_meval_usr (mps_context * ctx, mps_polynomial * p, mpcf_t x, mpcf_t value, rdpe_t error);
