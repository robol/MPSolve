        ...
        switch (argv[i][1]) {
            ...
            case 'M':
                switch (argv[i][2]) {
                    ...
                    case '-':
                        ...
                        break;
                    default:
                        mps_error(s, 3, "Bad multiplicity switch: ", argv[i]
                                + 2, ", use +|-");
                }
                if (strlen(argv[i]) != 3)
            ...
            case 'O':
                switch (argv[i][2]) {
                    ...
                    case 'f':
                        ...
                        break;
                    default:
                        mps_error(s, 3, "Bad output format switch: ", argv[i]
                                + 2, ", use b|c|f|g|v");
                }
                if (strlen(argv[i]) != 3)
                ...
                switch (argv[i][2]) {
                    case 'p':
                        ...
                        if (s->max_pack <= 0 || errno)
                            mps_error(s, 2,
                                    "Invalid number of packet iterations: ",
                                    argv[i] + 3);
                        break;
                    case 'i':
            ...
            case 'w':
                if (strlen(argv[i]) == 3 && argv[i][2] == '+')
                    ...
                    mps_error(s, 3, "Bad warning option: ", argv[i],
                            ", use +|-");
                break;
