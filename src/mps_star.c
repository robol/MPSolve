 ...
 */
void
mps_fcompute_starting_radii(mps_status* s, int n, int i_clust, double clust_rad,
 ...
 */
void
mps_dcompute_starting_radii(mps_status* s, int n, int i_clust, rdpe_t clust_rad,
