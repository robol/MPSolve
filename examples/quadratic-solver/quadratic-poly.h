...
void mps_quadratic_poly_mnewton (mps_context * s, mps_polynomial * poly, mps_approximation * root, mpcf_t corr, long int wp);
...
mps_boolean mps_quadratic_poly_meval (mps_context * ctx, mps_polynomial * p, mpcf_t x, mpcf_t value, rdpe_t error);
